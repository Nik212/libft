...
#                                                 +#+#+#+#+#+   +#+            #
#    Created: 2019/09/17 17:06:39 by slupe             #+#    #+#              #
#    Updated: 2019/09/18 18:43:31 by slupe            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS=ft_atoi.c ft_bzero.c ft_isalnum.c \
	 ...
	 ft_lstnew.c ft_lstiter.c ft_lstmap.c ft_lstappend.c
...
OBJ=ft_atoi.o ft_bzero.o ft_isalnum.o \
		...
		ft_lstnew.o ft_lstadd.o ft_lstdel.o ft_lstdelone.o \
	 	ft_lstnew.o ft_lstiter.o ft_lstmap.o ft_lstappend.o
